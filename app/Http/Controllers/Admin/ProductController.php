...
class ProductController extends Controller
{
    ...
    public function store(ProductRequest $request)
    {
        try {
            ...
            $product->category_id = Category::firstOrCreate([
                'name' => $request->category_id,
                'slug' => Str::of($request->category_id)->slug('-')
            ])->id;

            $product->manufacturer_id = Manufacturer::firstOrCreate([
                'name' => $request->manufacturer_id,
                'slug' => Str::of($request->manufacturer_id)->slug('-')
            ])->id;
