...
<body id="page-top">
    <div id="wrapper">
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item {!! nav_active('admin.order.*') !!}">
                ...
                <nav class="navbar navbar-expand navbar-light bg-white topbar mb-4 static-top shadow">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <input type="text" class="form-control bg-light border-0 small" name="search-general"
                                id="search-general" placeholder="Procurar por..." aria-label="Pesquisar"
                                ...
                                <form class="form-inline mr-auto w-100 navbar-search">
                                    <div class="input-group">
                                        <input type="text" class="form-control bg-light border-0 small"
                                            name="search-general" id="search-general-xs" placeholder="Procurar por..."
            ...
            <footer class="sticky-footer bg-white">
                <div class="container my-auto">
                    <div class="copyright text-center my-auto">
                        <span>Projeto Integrador I e II - Eixo de Computação | UNIVESP 2024 - {{ date('Y') }}</span>
                    </div>
                </div>
            </footer>
        </div>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    Você clicou no botão de Logout e está prestes a sair do sistema, deseja continuar?
                </div>
