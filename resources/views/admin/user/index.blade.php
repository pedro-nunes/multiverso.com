            ...
            <div class="col mb-3 ml-3">
                <div class="card bg-light" style="min-width: 250px">
                    <div class="card-body text-center">
                        <img src="https://bootdey.com/img/Content/avatar/avatar7.png" style="width:100px;" alt="Pedro"
                    ...
                    <div class="card-footer text-center">
                        ...
                        <a class="delete-user btn btn-sm btn-danger btn-icon-split" href="#" title="Excluir usuário"
                            data-toggle="modal" data-target="#modal-delete" data-subtitle="o usuário" data-url="#"
                            data-modal-item-name="{{ $user->name }}">
