                ...
                <div class="col-sm">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="document" id="document"
                            data-inputmask="'mask':'999.999.999-99'" value="{{  $user->document }}" required>
                    </div>
                </div>
            </div>
            <div class="row">
                <div class="col-sm-4 col-md-3">
                    <div class="form-group">
                        ...
                        <input type="tel" class="form-control" name="phone" id="phone"
                            data-inputmask="'mask':'99 9999-9999[9]'" value="{{ $user->phone }}" required>
                    </div>
                </div>
                ...
                <div class="col-12 col-sm-1 col-md-2">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control" name="state" id="state" maxlength="2"
                            data-inputmask="'mask':'AA'" value="{{ $user->state }}" required>
                    </div>
                </div>
            </div>
            <div class="row">
