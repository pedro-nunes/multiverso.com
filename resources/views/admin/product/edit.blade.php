            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-lg-3">
                            <div class="form-group">
                                <label for="weight">Peso: <small>(0.300)</small> <i class="text-danger">*</i></label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="height">Altura: <small>(cm)</small> <i class="text-danger">*</i></label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="width">Largura: <small>(cm)</small> <i class="text-danger">*</i></label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="length">Comprimento: <small>(cm)</small> <i
                    ...
                    <div class="row">
                        <div class="col-sm">
                            <div class="form-group">
                                <label for="variation">Variação do produto: <small>(Ex: Cor: Verde; Tam:
                                        50cm)</small></label>
