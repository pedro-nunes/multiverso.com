            ...
            <div class="row">
                <div class="col-lg-9">
                    <div class="row">
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                <label for="categories">Categoria: <i class="text-danger">*</i></label>
                        ...
                        <div class="col-sm-4">
                            <div class="form-group">
                                ...
                                <input list="manufacturers" name="manufacturer_id" class="form-control">
                        ...
                        <div class="col-lg-2">
                            <div class="form-group">
                                <label for="weight">Peso: <small class="text-muted">kg</small> <i
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="height">Altura: <small class="text-muted">cm</small> <i
                                        class="text-danger">*</i></label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="width">Largura: <small class="text-muted">cm</small> <i
                                        class="text-danger">*</i></label>
                        ...
                        <div class="col-lg-4">
                            <div class="form-group">
                                <label for="length">Comprimento: <small class="text-muted">cm</small> <i
                                        class="text-danger">*</i></label>
