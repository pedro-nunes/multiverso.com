            ...
            <div class="card-body">
                <div class="row no-gutters align-items-center">
                    <div class="col mr-2">
                        ...
                        <div class="h5 mb-0 font-weight-bold text-gray-800">
                            {{ count($products->where('stock', 0)) . ($products->count() > 1 ? ' produtos' : ' produto')
                            }}
                        </div>
                    </div>
                    <div class="col-auto">
                        ...
                        <div class="row no-gutters align-items-center">
                            <div class="col-auto">
                                <div class="h5 mb-0 mr-3 font-weight-bold text-gray-800">
                                    {{ count($products->where('stock', '<=', 'min_stock' )) . ($products->count() > 1
                                        ?
                                        ' produtos' : ' produto')
                                        }}
                                </div>
                        ...
                        <tr>
                            ...
                            <td colspan="4">
                                <div class="alert alert-info text-left" role="alert">
                                    <b>Informação<i class="fas fa-exclamation fa-fw"></i></b> Ainda não existe dados
                                    suficientes para serem exibidos aqui!
                                </div>
                            </td>
                        </tr>
                    </tbody>
